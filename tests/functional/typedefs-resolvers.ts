...
describe('typeDefs and resolvers', () => {
  describe('buildTypeDefsAndResolvers', () => {
    ...
    describe('typeDefs', () => {
      ...
      it('should generate object types', async () => {
        const sampleType1 = schemaIntrospection.types.find(it => it.name === 'SampleType1') as IntrospectionObjectType
        const sampleType2 = schemaIntrospection.types.find(it => it.name === 'SampleType2') as IntrospectionObjectType
        const sampleType1StringField = sampleType1.fields.find(it => it.name === 'sampleType1StringField')!
        const sampleType2StringField = sampleType2.fields.find(it => it.name === 'sampleType2StringField')!
      ...
      it('should generate union type', async () => {
        const sampleUnion = schemaIntrospection.types.find(it => it.name === 'SampleUnion') as IntrospectionUnionType
      ...
      it('should emit Date scalar', async () => {
        const dateScalar = schemaIntrospection.types.find(it => it.name === 'DateTime') as IntrospectionScalarType
    ...
    describe('resolvers', () => {
      ...
      it('should properly run subscriptions', async () => {
        ...
        await pubSub.publish('SAMPLE', payload)
      ...
      it('should generate simple resolvers function for queries and mutations', async () => {
        expect((resolvers.Query as ResolverObject<any, any>).sampleDateQuery).toBeInstanceOf(Function)
        expect((resolvers.Mutation as ResolverObject<any, any>).sampleBooleanMutation).toBeInstanceOf(Function)
      })
  ...
  describe('buildTypeDefsAndResolversSync', () => {
    ...
    describe('typeDefs', () => {
      ...
      it('should generate object types', async () => {
        const sampleType = schemaIntrospection.types.find(it => it.name === 'SampleType') as IntrospectionObjectType
        const sampleTypeStringField = sampleType.fields.find(it => it.name === 'sampleTypeStringField')!
