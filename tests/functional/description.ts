...
import { IntrospectionSchema, IntrospectionObjectType, IntrospectionInputObjectType } from 'graphql'

import { ObjectType, ArgsType, InputType, Resolver, Field, Query, Mutation, Arg, Args } from '../../src'
  ...
  describe('Schema', () => {
    ...
    beforeAll(async () => {
      ...
      class SampleObject {
        ...
        methodField(@Arg('arg', { description: 'sample object method arg description' }) arg: string): string {
          return 'methodField'
        }
      }
    ...
    it('should generate proper object fields descriptions', async () => {
      ...
      const describedGetterField = sampleObjectType.fields.find(field => field.name === 'describedGetterField')!
    ...
    it('should generate proper mutation type description', async () => {
      ...
      const describedMutation = mutationType.fields.find(field => field.name === 'describedMutation')!
    ...
    it('should generate proper mutation object args description', async () => {
      const argumentedMutation = mutationType.fields.find(field => field.name === 'argumentedMutation')!
    ...
    it('should generate proper input fields description', async () => {
      ...
      const describedField = sampleInputType.inputFields.find(field => field.name === 'describedField')!
