...
describe('Unions', () => {
  ...
  describe('Schema', () => {
    ...
    it('should correctly generate union type', async () => {
      ...
      const objectThree = oneTwoThreeUnionType.possibleTypes.find(type => type.name === 'ObjectThree')!
    ...
    it('should correctly generate union type from function syntax', async () => {
      ...
      const objectOne = oneTwoThreeUnionFnType.possibleTypes.find(type => type.name === 'ObjectOne')!
      const objectTwo = oneTwoThreeUnionFnType.possibleTypes.find(type => type.name === 'ObjectTwo')!
      const objectThree = oneTwoThreeUnionFnType.possibleTypes.find(type => type.name === 'ObjectThree')!
    ...
    it("should correctly generate query's union output type", async () => {
      const getObjectOneFromUnion = queryType.fields.find(field => field.name === 'getObjectOneFromUnion')!
    ...
    it("should correctly generate object type's union output type", async () => {
      const objectUnion = schemaIntrospection.types.find(type => type.name === 'ObjectUnion') as IntrospectionObjectType
