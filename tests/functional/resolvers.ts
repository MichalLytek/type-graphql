...
describe('Resolvers', () => {
  describe('Schema', () => {
    ...
    describe('Fields', () => {
      ...
      it('should generate proper field type for simple class method', async () => {
        const simpleMethodField = sampleObjectType.fields.find(field => field.name === 'simpleMethodField')!
    ...
    describe('Inline args', () => {
      ...
      it('should generate nullable string arg type for object field method when explicitly sets', async () => {
        const explicitNullableArg = argMethodField.args.find(arg => arg.name === 'explicitNullableArg')!
      ...
      it('should generate nullable string arg type for object field method', async () => {
        const nullableStringArg = argMethodField.args.find(arg => arg.name === 'nullableStringArg')!
    ...
    describe('Input object', () => {
      ...
      it('should generate non-nullable string arg type with defaultValue for input object field', async () => {
        const defaultValueStringField = sampleInputType.inputFields.find(arg => arg.name === 'defaultStringField')!
      ...
      it('should generate non-nullable string arg type with implicit defaultValue for input object field', async () => {
        ...
        expect(implicitDefaultValueStringField.defaultValue).toBe('"implicitDefaultStringFieldDefaultValue"')
      ...
      it('should overwrite defaultValue in child input object', async () => {
        const defaultValueStringField = sampleInputChildType.inputFields.find(arg => arg.name === 'defaultStringField')!
        const defaultValueStringFieldType = defaultValueStringField.type as IntrospectionNamedTypeRef
      ...
      it('should overwrite implicit defaultValue in child input object', async () => {
        ...
        expect(implicitDefaultValueStringField.defaultValue).toBe('"implicitDefaultValueOverwritten"')
        expect(implicitDefaultValueStringFieldType).toEqual({
          kind: 'NON_NULL',
          name: null,
          ofType: {
      ...
      it('should inherit field with defaultValue from parent', async () => {
        const inheritDefaultField = sampleInputChildType.inputFields.find(arg => arg.name === 'inheritDefaultField')!
    ...
    describe('Args object', () => {
      it('should generate simple arg from args object field', async () => {
        ...
        const stringArgInnerType = (stringArg.type as IntrospectionNonNullTypeRef).ofType as IntrospectionNamedTypeRef
      ...
      it('should overwrite implicit defaultValue in child args object field', async () => {
        const argsQuery = getQuery('argsInheritanceQuery')
        const implicitDefaultStringArg = argsQuery.args.find(arg => arg.name === 'implicitDefaultStringArg')!
      ...
      it('should generate non-nullable type arg with implicit defaultValue from args object field', async () => {
        ...
        expect(implicitDefaultStringArg.name).toEqual('implicitDefaultStringArg')
        expect(implicitDefaultStringArg.defaultValue).toEqual('"implicitDefaultStringArgDefaultValue"')
        expect(implicitDefaultStringArgType).toEqual({
          kind: 'NON_NULL',
          name: null,
          ofType: {
      ...
      it('should generate field args from field resolver args definition', async () => {
        const resolverFieldWithArgs = sampleObjectType.fields.find(field => field.name === 'resolverFieldWithArgs')!
        ...
        const arg1InnerType = (arg1.type as IntrospectionNonNullTypeRef).ofType as IntrospectionNamedTypeRef
        const arg2 = fieldResolverArgs.find(arg => arg.name === 'arg2')!
        const arg2InnerType = (arg2.type as IntrospectionNonNullTypeRef).ofType as IntrospectionNamedTypeRef
      ...
      it('should overwrite object field name from field resolver decorator option', async () => {
        const overwrittenField = sampleObjectType.fields.find(field => field.name === 'overwrittenField')!
    ...
    describe('Handlers', () => {
      ...
      it('should generate explicit nullable array of nullable string return type for query', async () => {
        const explicitNullableArrayWithNullableItemsQuery = getQuery('explicitNullableArrayWithNullableItemsQuery')
  ...
  describe('Functional', () => {
    ...
    beforeAll(async () => {
      ...
      class SampleResolver implements ResolverInterface<SampleObject> {
        ...
        @Query()
        queryWithRootContextAndInfo(@Root() root: any, @Ctx() context: any, @Info() info: any): boolean {
          queryRoot = root
        ...
        @Mutation()
        mutationWithTripleArrayInputs(@Arg('inputs', type => [[[SampleInput]]]) inputs: SampleInput[][][]): number {
          mutationInputValue = inputs
          return inputs[0][0][0].factor
        }

        @Mutation()
        mutationWithOptionalArg(@Arg('input', { nullable: true }) input?: SampleNestedInput): number {
        ...
        @FieldResolver()
        fieldResolverWithRoot(@Root() root: SampleObject): number {
          if (root.isTrue()) {
    ...
    it("shouldn't create instances of nested input fields nullable input objects when null provided", async () => {
      ...
      expect(mutationInputValue.nestedOptionalArrayField).toEqual([null, expect.any(classes.SampleInput)])
    })
  ...
  describe('Inheritance', () => {
    ...
    it('should generate proper subscriptions in schema', async () => {
      ...
      const prefixSubscription = subscriptionType.fields.find(it => it.name === 'prefixSubscription')!
