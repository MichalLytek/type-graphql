...
import { ObjectType, Resolver, Field, Query, Mutation, InputType, Arg, ArgsType, Args } from '../../src'
...
describe('Deprecation', () => {
  describe('Schema', () => {
    ...
    it('should generate proper object fields deprecation reason', async () => {
      ...
      const deprecatedField = sampleObjectType.fields.find(field => field.name === 'deprecatedField')!
      const deprecatedGetterField = sampleObjectType.fields.find(field => field.name === 'deprecatedGetterField')!
      ...
      expect(deprecatedGetterField.deprecationReason).toEqual('sample object getter field deprecation reason')
      expect(methodField.isDeprecated).toBeTruthy()
      expect(methodField.deprecationReason).toEqual('sample object method field deprecation reason')
    })
