...
describe('Interfaces and inheritance', () => {
  describe('Schema', () => {
    ...
    it('should generate type of interface extending other interface correctly', async () => {
      ...
      const interfaceStringField = getInnerFieldType(sampleInterfaceExtending1, 'interfaceStringField1')
    ...
    it('should generate type of interface implementing other interface correctly', async () => {
      ...
      expect(idFieldType.name).toEqual('ID')
      const interfaceStringField = getInnerFieldType(sampleInterfaceImplementing1, 'interfaceStringField1')
      expect(interfaceStringField.name).toEqual('String')
    ...
    it('should generate object type explicitly implementing interface correctly', async () => {
      ...
      const interfaceStringField = getInnerFieldType(sampleImplementingObject2Type, 'interfaceStringField1')
    ...
    it('should generate object type implicitly implementing interface correctly', async () => {
      ...
      const interfaceStringField1 = getInnerFieldType(sampleImplementingObject1Type, 'interfaceStringField1')
    ...
    it('should generate object type extending other object type correctly', async () => {
      ...
      const interfaceStringField1 = getInnerFieldType(sampleExtendingObject2Type, 'interfaceStringField1')
      const ownField2 = getInnerFieldType(sampleExtendingObject2Type, 'ownField2')
      const ownExtendingField2 = getInnerFieldType(sampleExtendingObject2Type, 'ownExtendingField2')
    ...
    it('should generate object type implementing interface when extending object type', async () => {
      ...
      const implementedInterfaceInfo = sampleExtendingObject2Type.interfaces.find(it => it.name === 'SampleInterface1')!
    ...
    it('should generate object type implicitly implementing mutliple interfaces correctly', async () => {
      ...
      const interfaceStringField1 = getInnerFieldType(sampleMultiImplementingObjectType, 'interfaceStringField1')
      const interfaceStringField2 = getInnerFieldType(sampleMultiImplementingObjectType, 'interfaceStringField2')
    ...
    it('should generate object type implicitly implementing and extending correctly', async () => {
      ...
      const interfaceStringField1 = getInnerFieldType(sampleExtendingImplementingObjectType, 'interfaceStringField1')
    ...
    it('should generate query args when extending other args class', async () => {
      ...
      const baseArgFieldType = getInnerType(queryWithArgs.args.find(arg => arg.name === 'baseArgField')!)
      const extendingArgFieldType = getInnerType(queryWithArgs.args.find(arg => arg.name === 'extendingArgField')!)
    ...
    it('should properly overwrite input type field', () => {
      const baseInputFieldType = getInnerInputFieldType(sampleSecondExtendedInputType, 'baseInputField')
  ...
  describe('Functional', () => {
    ...
    it('should allow interfaces to specify custom schema names', async () => {
      ...
      expect((data as any).renamedFieldInterfaceQuery.renamedInterfaceField).toEqual('interfaceFieldToBeRenamed')
    })
    ...
    it('should correctly transform data of overwritten input field', async () => {
      ...
      expect(errors).toBeUndefined()
      expect((data as any).secondImplementationPlainQuery.baseInterfaceField).toEqual('baseInterfaceField')
