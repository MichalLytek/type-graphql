  ...
  describe('Schema', () => {
    ...
    beforeAll(async () => {
      ...
      class SampleResolver {
        ...
        @Subscription({ topics: 'STH' })
        subscriptionWithArgs(@Arg('stringArg') stringArg: string, @Arg('booleanArg') booleanArg: boolean): boolean {
          return true
        }
    ...
    it('should correctly generate simple subscription type', () => {
      const sampleSubscription = subscriptionType.fields.find(field => field.name === 'sampleSubscription')!
    ...
    it('should correctly generate type of subscription with args', () => {
      const subscriptionWithArgs = subscriptionType.fields.find(field => field.name === 'subscriptionWithArgs')!
  ...
  describe('Functional', () => {
    ...
    beforeAll(async () => {
      ...
      class SampleResolver {
        ...
        async pubSubMutation(@Arg('value') value: number, @PubSub() pubSub: PubSubEngine): Promise<boolean> {
        ...
        @Mutation(returns => Boolean)
        async pubSubOtherMutation(@Arg('value') value: number, @PubSub() pubSub: PubSubEngine): Promise<boolean> {
    ...
    it('should create PubSub instance with provided emitter options', async () => {
      ...
      class SampleResolver {
        ...
        pubSubMutation(@PubSub() pubSubArg: PubSubEngine): boolean {
          void pubSubArg.publish('TEST', { test: true })
          return true
        }
      }
