...
import { Arg, buildSchema, ClassType, Field, getMetadataStorage, InputType, Query, Resolver } from '../../src'
...
describe('default values', () => {
  ...
  describe('when disableInferringDefaultValues is set', () => {
    ...
    beforeEach(async () => {
      ...
      class SampleResolver {
        @Query()
        sampleQuery(@Arg('input1') _input1: SampleInitializerInput, @Arg('input2') _input2: SampleOptionInput): string {
          return 'sampleQuery'
        }
      }
