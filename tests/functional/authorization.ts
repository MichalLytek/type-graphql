...
describe('Authorization', () => {
  ...
  describe('Reflection', () => {
    ...
    it('should register correct roles for object type fields', async () => {
      const sampleObject = getMetadataStorage().objectTypes.find(type => type.name === 'SampleObject')!
  ...
  describe('Functional', () => {
    ...
    it('should allow for access to authed object field from resolver when access granted', async () => {
      ...
      expect(result.data!.normalObjectQuery.inlineAuthedResolvedField).toEqual('inlineAuthedResolvedField')
    })
