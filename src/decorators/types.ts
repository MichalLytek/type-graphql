...
export type TypeValueThunk = (type?: any) => TypeValue
export type ClassTypeResolver = (of?: any) => ClassType | Function

export type ReturnTypeFunc = (returns?: any) => ReturnTypeFuncValue
