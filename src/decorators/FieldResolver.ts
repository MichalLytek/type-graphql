...
import { AdvancedOptions, ReturnTypeFunc, TypeOptions, TypeValueThunk } from './types'
...
export function FieldResolver(returnTypeFunction?: ReturnTypeFunc, options?: AdvancedOptions): MethodDecorator
