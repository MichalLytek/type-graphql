      ...
      return {
        ...
        type: new GraphQLObjectType({
          ...
          fields: () => {
            ...
            let fields = fieldsMetadata.reduce<GraphQLFieldConfigMap<any, any>>((fieldsMap, field) => {
        ...
        type: new GraphQLInterfaceType({
          ...
          fields: () => {
            ...
            if (interfaceType.interfaceClasses) {
              const implementedInterfacesMetadata = getMetadataStorage().interfaceTypes.filter(it =>
    ...
    this.inputTypesInfo = getMetadataStorage().inputTypes.map<InputObjectTypeInfo>(inputType => {
      ...
      return {
        ...
        type: new GraphQLInputObjectType({
          ...
          fields: () => {
            let fields = inputType.fields!.reduce<GraphQLInputFieldConfigMap>((fieldsMap, field) => {
