...
For a more advanced usage example with scoped containers, check out [advanced example with scoped containers](https://github.com/19majkel94/type-graphql/tree/v0.17.5/examples/using-scoped-container).
