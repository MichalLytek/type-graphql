...
See how subscriptions work in a [simple example](https://github.com/19majkel94/type-graphql/tree/v0.17.5/examples/simple-subscriptions).

For production usage, it's better to use something more scalable like a Redis-based pubsub system - [a working example is also available](https://github.com/19majkel94/type-graphql/tree/v0.17.5/examples/redis-subscriptions).
