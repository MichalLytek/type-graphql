 ...
 */
   ...
   */
  get category() {
    return CategoryDelegate(this.dmmf, this.fetcher, this.errorFormat, this.measurePerformance)
  }
  /**
   ...
   */
  get patient() {
    return PatientDelegate(this.dmmf, this.fetcher, this.errorFormat, this.measurePerformance)
  }
}
...
function CategoryDelegate(dmmf, fetcher, errorFormat, measurePerformance) {
  const Category = {} 
  Category.findOne = (args) => args && args.select ? new CategoryClient(
    dmmf,
    fetcher,
    'query',
    'findOneCategory',
  ...
  Category.findMany = (args) => new CategoryClient(
    dmmf,
    fetcher,
    'query',
    'findManyCategory',
  ...
  Category.create = (args) => args && args.select ? new CategoryClient(
    dmmf,
    fetcher,
    'mutation',
    'createOneCategory',
  ...
  Category.delete = (args) => args && args.select ? new CategoryClient(
    dmmf,
    fetcher,
    'mutation',
    'deleteOneCategory',
  ...
  Category.update = (args) => args && args.select ? new CategoryClient(
    dmmf,
    fetcher,
    'mutation',
    'updateOneCategory',
  ...
  Category.deleteMany = (args) => new CategoryClient(
    dmmf,
    fetcher,
    'mutation',
    'deleteManyCategory',
  ...
  Category.updateMany = (args) => new CategoryClient(
    dmmf,
    fetcher,
    'mutation',
    'updateManyCategory',
  ...
  Category.upsert = (args) => args && args.select ? new CategoryClient(
    dmmf,
    fetcher,
    'mutation',
    'upsertOneCategory',
  ...
  Category.count = () => new CategoryClient(dmmf, fetcher, 'query', 'aggregateCategory', 'categories.count', {}, ['count'], errorFormat)
  return Category
}
...
function PatientDelegate(dmmf, fetcher, errorFormat, measurePerformance) {
  const Patient = {} 
  Patient.findOne = (args) => args && args.select ? new PatientClient(
    dmmf,
    fetcher,
    'query',
    'findOnePatient',
  ...
  Patient.findMany = (args) => new PatientClient(
    dmmf,
    fetcher,
    'query',
    'findManyPatient',
  ...
  Patient.create = (args) => args && args.select ? new PatientClient(
    dmmf,
    fetcher,
    'mutation',
    'createOnePatient',
  ...
  Patient.delete = (args) => args && args.select ? new PatientClient(
    dmmf,
    fetcher,
    'mutation',
    'deleteOnePatient',
  ...
  Patient.update = (args) => args && args.select ? new PatientClient(
    dmmf,
    fetcher,
    'mutation',
    'updateOnePatient',
  ...
  Patient.deleteMany = (args) => new PatientClient(
    dmmf,
    fetcher,
    'mutation',
    'deleteManyPatient',
  ...
  Patient.updateMany = (args) => new PatientClient(
    dmmf,
    fetcher,
    'mutation',
    'updateManyPatient',
  ...
  Patient.upsert = (args) => args && args.select ? new PatientClient(
    dmmf,
    fetcher,
    'mutation',
    'upsertOnePatient',
  ...
  Patient.count = () => new PatientClient(dmmf, fetcher, 'query', 'aggregatePatient', 'patients.count', {}, ['count'], errorFormat)
  return Patient
}
